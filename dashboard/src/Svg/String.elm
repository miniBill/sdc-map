module Svg.String exposing
    ...
    , circle, defs, feColorMatrix, feGaussianBlur, feOffset, filter, g, image, polygon, rect, svg, text_, title, tspan, use
    )
...
@docs circle, defs, feColorMatrix, feGaussianBlur, feOffset, filter, g, image, polygon, rect, svg, text_, title, tspan, use

-}

import Html
import Svg.Types as Types exposing (Children(..), Html(..), Svg(..))
