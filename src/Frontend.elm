    ...
    Lamdera.frontend
        ...
        , view =
            \model ->
                { title = "SDC map"
                , body =
                    [ Html.node "style" [] [ Html.text "html {background: #C0BDB6; }" ]
                    , Element.layout
                        [ width fill
                        , height fill
                        , Theme.padding
...
viewInput input =
    ...
    , inputRow "contact" "Contact" "Some contact (email/xwitter/discord/...) you can use to prove it's you if you want to remove your information. Will not be published in any form." False Id input.id []
